    ...
    return (
        <div>
            <div className="post-event">
                ...
                <div>
                    <img className="post-event-image" src={photo} alt="photo bla" />
                </div>
                ...
                <div className="post-event-buttons">
                    <div>
                        ...
                        {/* <button onClick={props.deleteEvent} eventId={props.eventId} className="post-event-delete">Supprimer l'évenement</button> */}
                    </div>
